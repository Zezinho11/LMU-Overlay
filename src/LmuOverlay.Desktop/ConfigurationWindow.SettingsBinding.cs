...
public partial class ConfigurationWindow
{
    ...
    private OverlayProfileSettings ReadSettings(OverlayProfileSettings current)
    {
        ...
        return current with
        {
            ...
            SteeringWheelRangeDegrees = ParseDouble(
                SteeringWheelRangeDegrees.Text, 0, 0, 1440),
            UseDirectSteeringInput = UseDirectSteeringInput.IsChecked == true,
            SteeringInputDeviceId = ParseInt(SteeringInputDeviceId.Text, -1, -1, 15),
            ...
            AllowMultiMonitorPlacement = AllowMultiMonitorPlacement.IsChecked == true,
            EnableRemoteDashboard = EnableRemoteDashboard.IsChecked == true,
            RemoteDashboardPort = ParseInt(RemoteDashboardPort.Text, 28765, 1024, 65535),
